...
#Region " Private Members "
        ...
        Private Const CACHE_KEY As String = "-FeedbackCenter-CustomValues-All"
...
#Region " Public Methods "
        ...
        Public Function Add(ByVal objCustomValue As CustomValueInfo) As Integer
            ...
            DataCache.RemoveCache(objCustomValue.FeedbackID.ToString() & CACHE_KEY)
            Return CType(DataProvider.Instance().AddCustomValue(objCustomValue.FeedbackID, objCustomValue.CustomFieldID, objCustomValue.CustomValue), Integer)
        ...
        Public Sub Update(ByVal objCustomValue As CustomValueInfo)
            ...
            DataCache.RemoveCache(objCustomValue.FeedbackID.ToString() & CACHE_KEY)
            DataProvider.Instance().UpdateCustomValue(objCustomValue.CustomValueID, objCustomValue.FeedbackID, objCustomValue.CustomFieldID, objCustomValue.CustomValue)
