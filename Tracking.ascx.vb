...
Namespace Ventrian.FeedbackCenter
    ...
    Public MustInherit Class Tracking
...
#Region " Private Methods "
        ...
        Private Sub BindCrumbs()
            ...
            currentCrumb.Caption = Localization.GetString("Tracking", LocalResourceFile)
        ...
        Private Sub BindFeedback()
            ...
            Dim objFeedbackList As ArrayList = objFeedbackController.List(Me.ModuleId, Null.NullInteger, (lstStatus.SelectedValue = "Closed"), Null.NullString, SortType.CreateDate, SortDirection.Descending, Null.NullInteger, Null.NullInteger, Me.UserId, True, products)
            ...
            Else
                ...
                For i As Integer = 1 To objPagedDataSource.PageCount
                    ...
                    Else
                        strPages = strPages + "<a href=" & NavigateURL(Me.TabId, "", "fbType=Tracking", "Status=" & lstStatus.SelectedValue, "Page=" & (i - 1).ToString()) & " class=""Normal"">" & i.ToString() & "</a> "
                    End If
                Next
...
#Region " Event Handlers "
        ...
        Private Sub lstStatus_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstStatus.SelectedIndexChanged
            ...
            Response.Redirect(NavigateURL(Me.TabId, "", "fbType=Tracking", "Status=" & lstStatus.SelectedValue), True)
